...
function preload() {
  ...
  alienYellowWalkImage = loadAnimation("images/alienYellow_walk_1_1.png", "images/alienYellow_walk_1_2.png")
...
function setup() {
  ...
  bob = createSprite(68, 336,50,90);
  bob.scale = 0.8
  bob.x = 58
  bob.y = 80
  var animFrames = [];
  animFrames.push("images/alienYellow_walk_1_1.png");
  animFrames.push("images/alienYellow_walk_1_2.png");

  anim = construct(pInst.Animation, animFrames);
  //animations[label] = "GuardWalk";




  bob.addAnimation("guardwalk",anim );

  //guard = createSprite(202, 70);
  //guard.addAnimation("guardwalk",alienYellowWalkImage);
  gameState = "intro";
}
